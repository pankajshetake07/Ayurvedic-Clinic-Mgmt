    ...
    return (
        <div className="container-fluid vh-100">
            <div className="row h-100">
                ...
                >
                    {/* Image at the Top */}
                    <img src={Logo} alt="PrakritiSync Logo" height={150} width={200}></img>

                    <h3 className="text-center text-white mb-5 fw-bold">Welcome {receptionistName}</h3>
                        ...
                        {menuItems.map((item) => (
                            <li key={item.id} className="nav-item mb-4">
                                <button
                                    ...
                                    className={`nav-link text-white d-flex align-items-center gap-3 p-3 w-200 rounded shadow 
                ...
                <table className="table table-hover table-bordered">
                    ...
                    <tbody>
                        {appointments.map((appointment, index) => (
                            <tr key={index} style={{ backgroundColor: "#d4edda" }}> {/* Green Color */}
...
const CancelAppointments = () => {
    ...
    return (
        <div>
            <h2 className="text-danger">Cancel Appointments</h2>
            {appointments.length === 0 ? (
...
const menuItems = [
    ...
    { id: "viewAppointments", label: "View Appointments", icon: <FaCalendar /> },
    { id: "cancelAppointments", label: "Cancel Appointments", icon: <FaTimes /> },
];
